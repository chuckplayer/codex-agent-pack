...
if [[ "$skip_skills" -ne 1 ]]; then
  copy_one "$pack/.agents/skills" "$target_path/.agents/skills"
fi

if [[ "$skip_agents" -ne 1 ]]; then
  copy_one "$pack/.codex/agents" "$target_path/.codex/agents"
fi

copy_one "$pack/.codex/hooks.json" "$target_path/.codex/hooks.json"
copy_one "$pack/.codex/global-hooks.json" "$target_path/.codex/global-hooks.json"
copy_one "$pack/.codex/hooks" "$target_path/.codex/hooks"
